...
📌 **5개 자동차 회사 FAQ 500건+ 크롤링 → DB 적재 → Streamlit 서비스화**  

📌 **브랜드·연령·사용 목적 기준 트렌드 분석 및 시각화 제공**  

📌 **자동차 시장 의사결정 지원용 데모 서비스 구현**

🔹 역할: **팀 대표 발표 / EDA 및 시각화 중심 분석 담당**
...
📌 **XGBoost/LightGBM 등 비교 → Test Recall 63.9% 달성**  

📌 **고위험 고객 타겟 CRM 전략 도출**

🔹 역할: **팀장 / 전체 프로젝트 총괄 / 모델 분석·발표**
...
📌 **6개 보험사 약관 임베딩 → pgvector 기반 벡터 검색 구축**  

📌 **앙상블 리트리버 적용으로 정확도 향상**  

📌 **RAGAS 점수 0.4~0.5 달성, 확장성 제안 포함**

🔹 역할: **팀장 / 전체 아키텍처, 발표, 챗봇 데모 구현**
...
📌 **방 판별 → 빈 방 생성 → 가구 생성 모델 파이프라인 구축**  

📌 **SLLM 파인튜닝을 통한 한샘 특화 이미지 생성**

🔹 역할: **APM / 백엔드 100%, 프론트 50%, 데이터 수집 블로그, 뉴스 담당**
...
![AWS EC2](https://img.shields.io/badge/AWS_EC2-FF9900?style=flat)
![AWS S3](https://img.shields.io/badge/AWS_S3-569A31?style=flat)
